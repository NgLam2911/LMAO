...
class InfiniteDeath extends BaseSubCommand{

	/**
	 * @throws ArgumentOrderException
	 */
	protected function prepare() : void{
		$this->setPermission("lmao.infinitedeath");
	...
	public function onRun(CommandSender $sender, string $aliasUsed, array $args) : void{
		...
		$session->setInfiniteDeath(true, $time);
		$player->kill();
		$sender->sendMessage($player->getName() . " now death infinite times " . $time . " seconds !");
	}
}