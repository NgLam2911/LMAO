...
class NoPlace extends BaseSubCommand{

	/**
	 * @throws ArgumentOrderException
	 */
	protected function prepare() : void{
		$this->setPermission("lmao.noplace");
	...
	public function onRun(CommandSender $sender, string $aliasUsed, array $args) : void{
		...
		$session->setNoPlace(true, $time);
		$sender->sendMessage($player->getName() . " can't place blocks for " . $time . " seconds !");
	}
}