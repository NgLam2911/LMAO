...
class Freeze extends BaseSubCommand{

	/**
	 * @throws ArgumentOrderException
	 */
	protected function prepare() : void{
		$this->setPermission("lmao.freeze");
	...
	public function onRun(CommandSender $sender, string $aliasUsed, array $args) : void{
		...
		$session->setFreeze(true, $time);
		$sender->sendMessage($player->getName() . " has been frozen for " . $time . " seconds !");
	}
}