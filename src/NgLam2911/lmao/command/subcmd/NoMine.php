...
class NoMine extends BaseSubCommand{

	/**
	 * @throws ArgumentOrderException
	 */
	protected function prepare() : void{
		$this->setPermission("lmao.nomine");
	...
	public function onRun(CommandSender $sender, string $aliasUsed, array $args) : void{
		...
		$session->setNoMine(true, $time);
		$sender->sendMessage($player->getName() . " can't mine for " . $time . " seconds !");
	}
}